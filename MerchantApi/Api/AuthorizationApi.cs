...
namespace MerchantApi.Api
{
    ...
    public interface IAuthorizationApi : IApiAccessor
    {
        ...
        ApiResponse<AccessToken> AuthorizationCreateWithHttpInfo(AuthorityRequest body = null);
        /// <summary>
        /// Retrieve a checkout
        /// </summary>
        /// <remarks>
        ...
        /// <param name="id"></param>
        /// <returns>Checkout</returns>
        AccessToken AuthorizationGet(string id);
        ...
        System.Threading.Tasks.Task<AccessToken> AuthorizationCreateAsync(CreateOrderRequest body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<AccessToken>> AuthorizationCreateAsyncWithHttpInfo(CreateOrderRequest body = null);
    ...
    public partial class AuthorizationApi : IAuthorizationApi
    {
        ...
        /// <param name="id"></param>
        /// <returns>Checkout</returns>
        public AccessToken AuthorizationGet(string id)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of Checkout</returns>
        public ApiResponse<AccessToken> AuthorizationCreateWithHttpInfo(AuthorityRequest body = null)
        {

            var localVarPath = GetBasePath() + "oauth/token";
            ...
            {
                Exception exception = ExceptionFactory("AuthorizationCreateToken", localVarResponse);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of Checkout</returns>
        public async System.Threading.Tasks.Task<AccessToken> AuthorizationCreateAsync(CreateOrderRequest body = null)
        {
             ApiResponse<AccessToken> localVarResponse = await AuthorizationCreateAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (Checkout)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AccessToken>> AuthorizationCreateAsyncWithHttpInfo(CreateOrderRequest body = null)
        {
