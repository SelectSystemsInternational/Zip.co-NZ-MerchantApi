...
namespace MerchantApi.Model
{
    ...
    public partial class Order :  IEquatable<Order>, IValidatableObject
    {
        ...
        public Order(string OrderId = default(string), string OrderNumber = default(string), decimal? Amount = default(decimal?),
            OrderConsumer Consumer = default(OrderConsumer), Address Billing = default(Address), Address Shipping = default(Address), string Description = default(string), 
